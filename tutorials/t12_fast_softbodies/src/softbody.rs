...
use crate::{
    ...
    models::TetMesh, spatial_hash::SpatialHash,
};
...
fn vecSetZero(a: &mut [f32], anr: usize) {
    let ar = anr * 3;
    a[ar] = 0.0;
    a[ar + 1] = 0.0;
    a[ar + 2] = 0.0;
...
#[allow(non_snake_case)]
fn matGetDeterminant(a: &[f32; 9]) -> f32 {
    let a11 = a[0];
    let a12 = a[3];
    let a13 = a[6];
...
#[allow(non_snake_case)]
fn matSetMult(A: &[f32; 9], a: &mut [f32], anr: usize) {
